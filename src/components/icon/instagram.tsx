            ...
            <defs>
                ...
                */}
                <radialGradient
                    ...
                    fy='107%'
                    r='150%'>
                    <stop stopColor='#D4C4AE' offset='0%' />
                    <stop stopColor='#D4C4AE' offset='25%' />
                    <stop stopColor='#D4C4AE' offset='50%' />
                    <stop stopColor='#D4C4AE' offset='75%' />
                    <stop stopColor='#D4C4AE' offset='100%' />
                </radialGradient>
            </defs>
            <g>
                {/* GEMINI WRITTEN CODE THANK YOU  */}
